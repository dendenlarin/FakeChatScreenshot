...
- Правила и советы по изменениям описаны в `CONTRIBUTING.md`.
- Для сообщений об ошибках используйте шаблон issue (Bug report) в репозитории и приложите шаги воспроизведения/скриншоты.
